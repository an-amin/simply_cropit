...
function initCropit(i={}){try{if(null==i.image_editor)throw"arg.image_editor is undefined"}catch(i){return console.warn(i),i}let e={};e.imgWidth=null!=i.imgWidth?i.imgWidth:500,e.imgHeight=null!=i.imgHeight?i.imgHeight:500,e.previewWidth=null!=i.previewWidth?i.previewWidth:250,e.previewWidth=null!=i.previewWidth?i.previewWidth:250,e.quality=null!=i.quality?i.quality:.75,e.originalSize=null!=i.originalSize&&i.originalSize,e.previewHeight=null!=i.previewHeight?i.previewHeight:250,e.editor=$(document).find(i.image_editor),e.hiddenImgData=e.editor.find(".hidden-image-data"),e.error_container=null!=i.error_container&&e.editor.find(i.error_container),e.updateImgData=function(){var i=e.editor.cropit("export",{quality:e.quality,originalSize:e.originalSize});this.hiddenImgData.val(i)},e.debug=function(t,r=null){i.debug&&console.log(t+":",r),e.msg[t]=r,e.error_container&&e.error_container.prepend(JSON.stringify(e.msg)+"<br>")},e.msg={},e.editor.cropit({width:i.imgWidth,height:i.imgHeight,smallImage:"allow",onFileChange:function(){},onFileReaderError:function(i){e.debug("FileReaderError",i)},onImageLoading:function(){},onImageLoaded:function(){e.updateImgData()},onImageError:function(i){e.debug("ImageError",i.message)},onZoomChange:function(i){},onOffsetChange:function(i){e.updateImgData()}}),e.editor.cropit("previewSize",{width:e.previewWidth,height:e.previewHeight}),e.editor.on("click",".rotate-cw",function(){e.editor.cropit("rotateCW"),e.updateImgData()}),e.editor.on("click",".rotate-ccw",function(){e.editor.cropit("rotateCCW"),e.updateImgData()})};